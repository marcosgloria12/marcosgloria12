    ...
    <div style={styles.page}>
      <div style={styles.left}>
        ...
        <div style={styles.heroText}>
          <h1 style={styles.heroH1}>Tudo que seu clube<br/>precisa, em um só lugar.</h1>
          <p style={styles.heroP}>Membros, presença, eventos, comunicação e relatórios — integrados e simples.</p>
        </div>
        ...
        <div style={styles.formCard}>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? <><span className="spinner" style={{borderColor:'rgba(255,255,255,0.3)',borderTopColor:'#fff'}}></span> Entrando...</> : 'Conectar'}
            </button>
          </form>

          <p style={styles.forgotPwd}>
            Esqueceu a senha? <a href="mailto:suporte@desbrasys.com.br">Fale com o suporte</a>
          </p>
        </div>
        <p style={styles.copyright}>© 2026 DesbraSys — Todos os direitos reservados</p>
      </div>
    </div>
  )
}
...
const styles = {
  ...
  brandSub: { fontSize: '12px', color: 'rgba(255,255,255,0.5)', marginTop: '2px' },
  ...
  heroP: { fontSize: '15px', color: 'rgba(255,255,255,0.65)', lineHeight: '1.7', maxWidth: '380px' },
  ...
  formTitle: { fontSize: '22px', fontWeight: '600', color: 'var(--text-primary)' },
  formSub: { fontSize: '13px', color: 'var(--text-secondary)', marginTop: '4px' },
  ...
  forgotPwd: { fontSize: '12px', color: 'var(--text-muted)', textAlign: 'center', marginTop: '16px' },
  copyright: { fontSize: '11px', color: 'var(--text-muted)', textAlign: 'center' },
}
